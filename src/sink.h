...
#ifndef NEWFON_SINK_H
#define NEWFON_SINK_H
...
extern void sink_setup(sink_t *consumer, void *buffer, size_t bufsize, newfon_callback function, void *user_data);
